...
/*
  function findQuestion(question) {
    return question.text  === selectedButton.dataset.question
    }
    if (quizData.questions.find(findQuestion).selected !== null) {
      return;
    } else {
    quizData.questions.find(findQuestion).selected = selectedButton.dataset.answerKey;
    selectedButton.style.borderColor = 'gold'
  }*/
